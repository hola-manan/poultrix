...
|--------------------------------------|--------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|
| [crop/phenology.py](src/jeevn/domain/crop/phenology.py) | Per-crop growth stages, Kc, NDVI ranges, nutrient targets, yield potential                       | Static lookup tables for apple / wheat (default fallback = wheat)                                     |
...
| [soil/management.py](src/jeevn/domain/soil/management.py) | pH classification, salinity tier, SOC status, CEC, WHC, recommendations                          | USDA salinity scheme, ICAR thresholds                                                                 |
